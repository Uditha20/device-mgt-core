/*
 * Copyright (c) 2024, Entgra (Pvt) Ltd. (http://www.entgra.io) All Rights Reserved.
 *
...
public class LogsDetailsWrapper {
    ...
    private List<LogPayload> payload;
    ...
    public List<LogPayload> getPayload() {
        return payload;
    }

    public void setPayload(List<LogPayload> payload) {
